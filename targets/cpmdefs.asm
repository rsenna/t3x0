...
FCB_DISK	equ	 0	; Disk ID, 0=default, 1=A:, ...
...
BDREADCONS	equ	10	; Read Console String
...
BDSEARCH	equ	17	; Search First Match, DE=FCB, A=FF: failure
                                ; result in DMA buf at offset A*32
